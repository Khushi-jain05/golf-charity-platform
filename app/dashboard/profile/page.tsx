...
export default function Profile() {
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    setProfile((p: any) => ({ ...p, full_name, phone, location, bio }))
    setSaving(false)
    setSaved(true)
      ...
      <aside className="w-[240px] bg-[#1a1f1a] flex flex-col fixed h-full z-10">
        ...
        <nav className="flex-1 px-3 py-4 space-y-0.5">
          ...
          {[
            ...
            { label: 'Profile',      href: '/dashboard/profile',      active: true,  d: 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z' },
        ...
        <div className="p-8 space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="flex items-center gap-5 pb-6 border-b border-gray-100">
              <div className="w-20 h-20 rounded-full bg-green-100 flex items-center justify-center text-2xl font-bold text-green-700 flex-shrink-0">
                {initials}
              </div>
              ...
              <button className="border border-gray-200 hover:bg-gray-50 text-gray-700 text-sm font-semibold px-4 py-2 rounded-xl transition">
                Edit Photo
              </button>
            </div>
            ...
            <div className="grid grid-cols-4 pt-5">
              {[
                ...
                {
                  value: profile?.charity_count || 4,
                  label: 'Charities Supported',
                  icon: <svg className="w-5 h-5 text-green-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>,
                },
              ].map((s) => (
            ...
            <form onSubmit={handleSave} className="space-y-5">
              ...
              <div>
                ...
                <input value={email} disabled
                  className="w-full border border-gray-100 rounded-xl px-4 py-2.5 text-sm text-gray-400 outline-none bg-gray-50 cursor-not-allowed" />
              </div>
              ...
              <div>
                ...
                <textarea value={bio} onChange={e => setBio(e.target.value)} rows={3}
                  className="w-full border border-gray-200 hover:border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-100 rounded-xl px-4 py-2.5 text-sm text-gray-900 outline-none transition bg-gray-50 focus:bg-white resize-none"
                  placeholder="Tell us a bit about yourself and your golf game..." />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <input value={homeClub} onChange={e => setHomeClub(e.target.value)}
                    className="w-full border border-gray-200 hover:border-gray-300 focus:border-green-500 focus:ring-2 focus:ring-green-100 rounded-xl px-4 py-2.5 text-sm text-gray-900 outline-none transition bg-gray-50 focus:bg-white"
              ...
              <div className="flex items-center justify-between pt-2">
                ...
                <button type="submit" disabled={saving}
                  className="bg-green-600 hover:bg-green-500 disabled:opacity-60 text-white font-bold px-8 py-2.5 rounded-xl text-sm transition">
          ...
          <div className="bg-white rounded-2xl border border-red-100 shadow-sm p-6">
            ...
            <div className="flex items-center justify-between py-3 border-t border-gray-100">
              ...
              <button className="border border-red-200 hover:bg-red-50 text-red-500 text-sm font-semibold px-4 py-2 rounded-xl transition">
                Delete Account
              </button>
            </div>
          </div>
